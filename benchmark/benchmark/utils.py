...
class PathMaker:
    ...
    @staticmethod
    def agg_file(
        type, faults, nodes, workers, collocate, rate, tx_size, max_latency=None
    ):
...
def progress_bar(
    iterable, prefix="", suffix="", decimals=1, length=30, fill="█", print_end="\r"
):
    total = len(iterable)
