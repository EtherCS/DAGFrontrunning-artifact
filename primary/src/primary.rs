...
impl Primary {
    pub fn spawn(
        ...
        rx_consensus: Receiver<Certificate>,    // receive the ordered certificates from consensus (for cleanup and controlling front-run)
    ) {
        ...
        GarbageCollector::spawn(&name, &committee, consensus_round.clone(), rx_consensus, tx_clean_certificate);
